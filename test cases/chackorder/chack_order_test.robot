...
Open Browser with GUI and Logging
    ...
    Click Element   xpath=/html/body/section[3]/div/div/a
    Execute JavaScript  document.querySelector("#navbarSupportedContent ul li:nth-child(4) a").click();
    Execute JavaScript  document.querySelector("#navbarSupportedContent > ul > li:nth-child(4) > div > a:nth-child(1)").click();
    Capture Page Screenshot
    
    Wait Until Page Contains Element  xpath=/html/body/section[3]/div/div[2]/table/tbody/tr[2]/td[3]/a
    Wait Until Element Is Visible  xpath=/html/body/section[3]/div/div[2]/table/tbody/tr[2]/td[3]/a
    Click Element  xpath=/html/body/section[3]/div/div[2]/table/tbody/tr[4]/td[3]/a
    Capture Page Screenshot
